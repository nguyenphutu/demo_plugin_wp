...
function sinetiks_students_list() {
    ?>
    ...
    <div class="wrap">
        ...
        <div class="tablenav top">
            <div class="alignleft actions">
                <a href="<?php echo admin_url('admin.php?page=sinetiks_students_create'); ?>">Add New</a>
            </div>
            <br class="clear">
        </div>
        <?php
        ...
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo admin_url('admin.php?page=sinetiks_students_update&id=' . $row->id); ?>">Update</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
